    ...
    setData(array.map(function (object) {
      return {
        ...
        ownerInfo: function ownerInfo() {
          __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx("p", null, "Name: ".concat(object.ownerFirstName, " ").concat(object.ownerLastName)), __jsx("p", null, "Phone: ".concat(ownerCellPhone)), __jsx("p", null, "Email: ".concat(ownerEmail)));
        },
        foodInfo: '',
        fixed: object.fixed,
        vetInfo: ''
...
//# sourceMappingURL=archive.js.ca3ddc5323c93a281a48.hot-update.js.map