...
/* harmony default export */ __webpack_exports__["default"] = (props => {
  ...
  const handleSubmit = async event => {
    ...
    let response = await axios__WEBPACK_IMPORTED_MODULE_4___default.a.post('/login', login); //need to send the admin flag to users
    //router.push({ pathname: response.data.redirectUrl, query: response.data.query.adminflag })

    response.data.success ? next_router__WEBPACK_IMPORTED_MODULE_5___default.a.push({
